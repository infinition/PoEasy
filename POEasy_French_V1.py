...
premier_bouton = Button(window, text="Lancer le programme", font="Courrier", bg="White", fg='black', command=lancement1)
premier_bouton.pack(pady=25, fill=X)
 
#Aide
label_aide = Label(window, text="Valider tous les champs (même si vide) avant de cliquer sur lancer le programme !", font="Courrier", bg="black", fg='red')
label_aide.pack()
